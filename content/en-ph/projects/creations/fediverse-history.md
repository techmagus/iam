+++
title = "The Federated SNS (Fediverse) Historical Timeline"
description = "A timeline of key points in the history of the fediverse or the federated social network."
...
slug = "fediverse-history-timeline"
translationKey = "fediverse-history-01"
...
#audio = [""]
images = ["img/projects/fediverse-high-tech.jpg"]
#videos = ["https://www.youtube.com/watch?v="]

link = "https://codeberg.org/ddfon/federated-sns"
...
For example. There is some information I remember about the {{% quote type="name" lang="en" %}}Federated Social Web{{% /quote %}}. However, since this information is no longer available (sites went offline and there are no archives elsewhere), I did not include these in the timeline.
...
### The Federated SNS Historical Timeline

- techmagus: [The Federated SNS Timeline (Fediverse History)](https://im.youronly.one/techmagus/kb/ddfon/federated-social-network-timeline-2022346/)
- codeberg: [DDFON Federated SNS repository](https://codeberg.org/ddfon/federated-sns)
